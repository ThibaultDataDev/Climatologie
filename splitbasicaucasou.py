...
def split_datas(filename, columnwanted, sousdossier):
    ...
    COUNTRY_FILES_PATH = os.getcwd() + os.sep + "data" + os.sep + "CURATED" + os.sep + columnwanted + os.sep + sousdossier + os.sep
